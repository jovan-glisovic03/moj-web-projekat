...
if (isset($_POST['sacuvaj'])) {
    ...
    // FINALNI UPIT: Ažuriramo red koji je prethodno kreiran
    ...
    header("Location: azuriranje_rez.php");
    exit();
}
}
?>
...
<head>
    ...
    <title>Ažuriranje rezultata</title>
</head>
<body>
    ...
    <div class="form-wrapper1">
        <section class="form-box1">
            <h2>Formular za ažuriranje rezultata</h2>
